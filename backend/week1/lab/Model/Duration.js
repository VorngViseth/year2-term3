export class Duration {
    ...
    */
    ...
    // YOUR CODE
        ...
        const D  = new Duration(totalSeconds);
    ...
    */
    plus = (other) => {
    // YOUR CODE
        const totalDurationInSecs = this._totalSeconds + other._totalSeconds;
        return new Duration(totalDurationInSecs);
    }
    /**
    * YOUR COMMENT
    */
    ...
    // YOUR CODE
        const totalDurationInSecs = this._totalSeconds - other._totalSeconds;
        return new Duration(Math.max(0, totalDurationInSecs));
    }
}